        ...
        <img className="w-[50%] rounded-lg"
              ...
              <div className="px-6 py-4">
                ...
                <p className="leading-normal text-gray-700">
                  ...
                  Praesentium, quibusdam facere quo laborum maiores sequi nam
                  tenetur laudantium.
                </p>
              </div>
            </div>

            <div className="max-w-lg mx-4 mb-4 rounded-lg">
              <div className=" flex justify-center rounded-lg bg-gray-100">
                <img className="w-[95%] p-4"
            ...
            <div className="max-w-md mx-4 mb-4 rounded-lg">
              <div className="py-12 flex justify-center rounded-lg bg-gray-100">
                <div className="rounded-lg w-56"> <div> 
                <img
